export const funkyDocs = {
  ...
  functions: {
    ...
    sqrt: {
      ...
      params: [{ name: "x", type: "number", note: "≥0" }],
      example: "sqrt(4)  // returns 2",
    },
    sin: {
      signature: "sin(x)",
      description: "Sine of x (degrees)",
      params: [{ name: "x", type: "degrees" }],
      example: "sin(Time * 90)",
    },
    cos: {
      signature: "cos(x)",
    ...
    asin: {
      ...
      params: [{ name: "x", type: "number", note: "-1..1" }],
    ...
    smooth: {
      ...
      params: [
        { name: "x", type: "number" },
        { name: "rate", type: "number", note: "units/sec" },
      ],
    ...
    ammo: {
      ...
      params: [{ name: "weapon", type: "string" }],
      example: 'ammo("Cannon")',
    },
  },
